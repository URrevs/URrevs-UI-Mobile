...
class ReportInteractionBody extends StatefulWidget {
  const ReportInteractionBody({
    Key? key,
  ...
  @override
  State<ReportInteractionBody> createState() => _InteractionBodyState();
}

class _InteractionBodyState extends State<ReportInteractionBody> {
